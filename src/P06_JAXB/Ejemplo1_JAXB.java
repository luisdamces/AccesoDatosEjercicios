...
public class Ejemplo1_JAXB {
    ...
    public static void main(String[] args) throws JAXBException, IOException {
        ...
        Libro libro1 = new Libro("Matrix", "Dolores Fuertes de Barriga",
        		"Planeta","978-84-1545-297-3" );
        libroLista.add(libro1);
        Libro libro2 = new Libro("El señor de los anillos", "Tolkien",
        		"Anaya","978-84-1545-228-7" );
        ...
        Libreria libreria2 = (Libreria) unmars.unmarshal(
        		new FileReader(MIARCHIVO_XML));
