...
public class Escritura_fichero_aleatorio {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] apellidos = new String[10];
			apellidos[0]="Martinez";  apellidos[1]="Sanchez";
			apellidos[2]="Hernandez"; apellidos[3]="Fernandez";
			apellidos[4]="Perez";     apellidos[5]="Alonso";
			apellidos[6]="Rodriguez"; apellidos[7]="Moreno";
			apellidos[8]="Lopez";     apellidos[9]="Navas";
		...
		double[] salario = new double[10];
			salario[0]=100; salario[1]=200;
			salario[2]=300; salario[3]=400;
			salario[4]=500; salario[5]=600;
			salario[6]=700; salario[7]=800;
			salario[8]=900; salario[9]=950;
